...
function TestimonialCard({ quote, author, role, date, initials, gradient, className }) {
  return (
    <figure
      className={cn(
  ...
  return (
    <section id="testimonials" className="relative bg-gradient-to-b from-muted/30 to-background py-20 sm:py-32 overflow-hidden">
      ...
      <div className="mt-6 flex items-center justify-center gap-4 text-sm text-muted-foreground">
        <span>Xem đánh giá độc lập tại:</span>
        <a
          href="https://www.google.com/maps/place/D%E1%BA%A1y+to%C3%A1n+th%E1%BA%A7y+Long"
          target="_blank"
        ...
        <span>·</span>
        <a
          href="https://www.facebook.com/daytoanthaylong"
          target="_blank"
          rel="noopener noreferrer"
          className="font-semibold text-primary hover:underline"
        >
      ...
      <div className="relative mt-10 flex flex-col gap-4 [--duration:35s]">
